...
public class DynamoDBHandlerUtils {
    public static final String TABLES_TABLE_NAME = "cmtr-4d2d00ed-Tables-test";
    public static final String RESERVATIONS_TABLE_NAME = "cmtr-4d2d00ed-Reservations-test";
